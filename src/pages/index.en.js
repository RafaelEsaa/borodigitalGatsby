	...
	render() {
		...
		return (
			<Layout location={location} menuFixed={true}>
						...
						<div style={{ maxWidth: `100%` }}>
							<div className="mensaje-banner">
								...
								<h3 className="no-margin">
									An idea is a good start for a big project
								</h3>
							</div>
							<Img
								className="banner-title"
								fluid={data.imageMensaje.childImageSharp.fluid}
							/>
						</div>
						<p />
					</div>
				...
				<div
					id="contact-us"
					className="row justify-content-md-center justify-content-sm-center footer no-margin"
				>
					<div className="col-md-6 col-sm-10 form">
						<ContactForm />
					</div>
				</div>
